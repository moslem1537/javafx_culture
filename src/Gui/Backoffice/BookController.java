...
public class BookController extends ListCell<Product> {
    ...
    @Override
    protected void updateItem(Product student, boolean empty) {
        ...
        if(empty || student == null) {
           ...
           // Image image = new Image(getClass().getResourceAsStream("/Gui/Images/"+student.getImg()));
            Image image = new Image(getClass().getResourceAsStream("/Gui/Images/alchimiste.PNG"));
            productImage.setImage(image);
            lbName.setText(student.getNom());
          //  lbDesc.setText(student.getDescription());
            //lbRef.setText(student.getRef());
            lbPrice.setText(String.valueOf(student.getPrix()));
            lbQty.setText(String.valueOf(student.getQuantite()));
