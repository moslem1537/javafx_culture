...
public class MyBookController {
    ...
    public void setData(Product produit, AnchorPane content){
        centerContent = content;
        //Image image = new Image(getClass().getResourceAsStream(produit.getImg()));
        Image image = new Image(getClass().getResourceAsStream("/Gui/Images/14af758e113a89ea28c917e26caf171d.png"));
