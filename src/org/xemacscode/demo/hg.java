 ...
 * @author user
 */
public class hg implements Initializable {
    ...
    private void afficherPublicationFront() throws IOException {
        ...
        Connection conn;
        try{
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/clt?useLegacyDatetimeCode=false&serverTimezone=CET", "root","");
            return conn;
        }catch(Exception ex){
